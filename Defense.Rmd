...
For any model M, $|\mathcal{M}|$ will be used to denote the number of predictors contained in the model.  The true model size would be indicated by $|\mathcal{T}_1| = p_0$  and $|\mathcal{T}_2| = q_0$ or together would be $|\mathcal{T}|=d_0=p_0+q_0$. For the procedure, three sets will be used throughout. The sets are M for the model set, C for the candidate set of predictors and S for the solution set of predictors currently selected in the model. </p>
